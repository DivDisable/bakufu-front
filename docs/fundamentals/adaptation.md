...
так или иначе человек сталкивается с явлениями адаптации. Но достанет ли нормально человеку знаний облачить то, что он мыслит
об адаптации в словесную, логическую и структурированную форму? Едва ли. Поэтому когда Вы прочитаете какой-нибудь факт
об адаптации и скажите: "нееет... ну это и так понятно", спросите себя, смогли бы выразить словами 
явление, факт о котором Вы прочли?
...
Алексей в большей степени вкладывал сюда что-то метафизическое и эфимерное. Но что насчёт начуного подхода?

Насколько лазание естественный процесс для человеческого тела? Настолько, насколько естественен процесс
бега на двух ногах для шимпанзе. Всё ещё не понятно?

Очевидно, что человек раньше начал лазать по деревьям, чем по скалам, вот о лазании по деревьям и поговорим.
В лазании по деревьям очень важно, чтобы голеностопный сустав имел значительный угол сгибания. Угол сгибания
позволяет приблизить центр масс ближе к дереву.

<img src="https://storge.pic2.me/cm/2560x2048/726/55a0120da48e6.jpg" width="500" height="500" />

В Филлипинах живут коренные охотники-собиратели Тва, которые лазают по деревьям с самого детства. Если измерить угол,
на который может изгибаться их голеностопный сустав и сравнить его с обезьянами или обычными людьми, то получится
диаграмма следующего вида:

<img src={require('@site/static/img/adaptation_diagram.png').default} width="500" height="500" />
...
У обезьян есть анатомическое преимущество, позволяющая ей сгибать стопу в плюсне ещё и противопостовлять большой
палец, фактически использую нижние конечности, как верхние. Человек лишён такой анатомической возможности.
...
плечевые кости обезьян плотнее, чем человеческие, что лучше для лазания.
...
Вернёмся к началу: лазание настолько же естественно для человека, как и прямохождение для обезьян. Да, они адаптируются
к непривычными условиям, но это лежит за пределами их анатомической предрасположенности, поэтому с научной точки зрения
**лазание не является естественным для человека способом передвижения**.
...
```mermaid
graph TD;
	A(факторы адаптации) --> адекватные
	A --> неадекватные
```
...
Будьте честны перед собой. Что же вы, люди, такое делаете со своим немощным телом? Неужели хотите уподобиться рыбам,
...
Цель адаптации для Вас состоит в том, чтобы работать с сильными и очень сильными неадекватными факторами, избегая
сверхсильных, потому как последние приводят к патологии.

:::note ЗАМЕТКА
Куда бы Вы не шли - Вы идёте в ногу с природой. Противоречия лишь её часть.
:::
...
Ответ часто носит уникальный, избирательный характер. И увеличится мощность только тех структур, которые необходимы.
...
Это явление получило название **смена доминант**
